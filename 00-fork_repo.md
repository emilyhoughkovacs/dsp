...
Option 2:  _Intermediate:_ Edit files using GitHub pull/pull.  Follow "Set Up Repo on GitHub" [Step 5: Set up repo ](/04-set_up_repo.md)
...
My two favorite emojis are :baby_chick: and :information_desk_person:.
...
More advanced instructions are available at [Step 5: Set up repo ](/04-set_up_repo.md)
